---
title: "Chatbot Thời Trang Tư Vấn Size & Chốt Đơn"
description: "Bộ chỉ dẫn đầy đủ giúp chatbot shop thời trang tư vấn size theo dáng người Việt, xử lý từ chối khéo và chốt đơn ngay trong khung chat."
businessModel: ban-le
industry: thoi-trang
tags: [chatbot, tu-van, chot-don, size]
cover: https://pub-c5d3e1873a534ee89daedcf9e6dc380b.r2.dev/template/thoitrang.png
featured: true
...
Khách hỏi size nhưng tư vấn chung chung, hỏi dồn dập rồi để khách "đi xem thêm" là mất đơn. Bộ chỉ dẫn này cho chatbot quy trình tư vấn mượt mà: hiểu nhu cầu → tư vấn size theo chiều cao/cân nặng → xử lý từ chối → chốt đơn → thu thanh toán, kèm bảng size chuẩn dáng người Việt.
...
4. Bảng size là chuẩn dáng người Việt phổ biến — chỉ chỉnh nếu form sản phẩm của shop khác chuẩn chung.
5. Các phần KHÔNG có `[ ]` là logic vận hành chung (NLU, khuyến mãi, quy tắc tư vấn, phong cách) — giữ nguyên, đây là phần lõi giúp bot chốt đơn thông minh.
...
- `[ĐIỀN NHU CẦU PHÙ HỢP]` — dịp dùng (đi làm, đi chơi, đi tiệc…).
...
- `[ĐIỀN CHÍNH SÁCH ĐỔI TRẢ]` — điều kiện đổi size/đổi màu.
...
## Ví dụ đã điền sẵn — Tias Fashion

Đây là bản đã điền hoàn chỉnh cho shop **Tias Fashion** để anh/chị tham khảo cách điền. Anh/chị có thể copy nguyên bản rồi đổi lại tên shop, sản phẩm, chính sách ship và thông tin chuyển khoản thành của mình.
